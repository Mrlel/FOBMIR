...
// Toutes les routes de ce fichier gèrent des données de référence internes
// (quartiers, chefs, ménages...) : elles nécessitent d'être authentifié.
// L'inscription publique (auto-enregistrement) utilise ses propres routes
// AJAX dédiées dans routes/web_independant.php.
