...
@section('title', 'Nouveau chef de sous-quartier')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <form action="{{ route('chefs-sous-quartier.store') }}" method="POST">
                    @csrf
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control @error('date_nomination') is-invalid @enderror" 
                                           id="date_nomination" name="date_nomination" value="{{ old('date_nomination') }}">
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-save"></i> Créer le chef
                        </button>
                        <a href="{{ route('chefs-sous-quartier.index') }}" class="btn btn-secondary ml-2">
