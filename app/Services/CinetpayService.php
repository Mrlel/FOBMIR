...
require_once app_path('Libraries/cinetpay-sdk-php/src/CinetPay.php');
require_once app_path('Libraries/cinetpay-sdk-php/commande.php');
use Exception;
...
class CinetpayService
{
   ...
   /**
     ...
     * @throws Exception
     */
    public function generatePayment(string $transactionId, float $amount, string $currency = 'XOF', string $description = 'Payment description', array $additionalParams = []): array
    {
